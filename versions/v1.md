...
Schema: 3 tables (rag_chunks with vector(1536) column + HNSW index, rag_entities, rag_relationships).
...
3. **Embedding upgrade**: voyage-3-large (1024 dims, better retrieval) or text-embedding-3-large (3072 dims). Benchmark both on retrieval metrics before switching.
